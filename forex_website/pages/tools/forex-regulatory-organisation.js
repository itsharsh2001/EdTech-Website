import Page from '../../components/Tools/ForexRegulatoryOrganisation.js'
...
export default function ForexRegulatoryOrganisation() {
    ...
    return (
        <>
        <Head>
        <title>Forex Regulatory Organisation</title>
